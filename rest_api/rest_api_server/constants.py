...
class UrlsV2(Urls):
    ...
    urls_map = dict(Urls.urls_map, **{
        ...
        'report_import_queue_stats': r"%s/report_import_queue_stats",
        'resource_duplicates_collection':
            r"%s/cloud_accounts/(?P<cloud_account_id>[^/]+)/resource_duplicates",
        ...
        'sso_login_config': r"%s/sso_login_config",
        ...
        'virtual_tags_collection': r"%s/organizations/(?P<organization_id>[^/]+)/virtual_tags",
        'virtual_tags_copy': r"%s/organizations/(?P<organization_id>[^/]+)/virtual_tags_copy",
        'virtual_tag_resource_options': r"%s/organizations/(?P<organization_id>[^/]+)/virtual_tag_resource_options",
        'virtual_tags': r"%s/virtual_tags/(?P<id>[^/]+)",
        'virtual_tag_value_limits': r"%s/virtual_tags/(?P<id>[^/]+)/value_limits",
        'virtual_tag_rules_collection': r"%s/organizations/(?P<organization_id>[^/]+)/virtual_tag_rules",
        'virtual_tag_rules': r"%s/virtual_tag_rules/(?P<id>[^/]+)",
        'virtual_tag_rules_apply': r'%s/organizations/(?P<organization_id>[^/]+)/virtual_tag_rules_apply',
        ...
        'invoice_months': r"%s/organizations/(?P<organization_id>[^/]+)/invoice_months",
        'import_scheduler': r"%s/organizations/(?P<organization_id>[^/]+)/import_scheduler",
