    ...
    if not version or version == 'v2':
        ...
        result.extend([
            ...
            (urls_v2.schedule_imports,
             ...
             handler_kwargs),
            (urls_v2.report_import_queue_stats,
             h_v2.report_import_queue_stats.ReportImportQueueStatsAsyncHandler,
             handler_kwargs),
            ...
            (urls_v2.report_imports,
             ...
             handler_kwargs),
            (urls_v2.resource_duplicates_collection,
             h_v2.resource_duplicates.ResourceDuplicatesAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.invites,
            ...
            (urls_v2.live_demo, h_v2.live_demos.LiveDemoAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.sso_login_config,
             h_v2.sso_login_config.SsoLoginConfigAsyncHandler, handler_kwargs),
            ...
            (urls_v2.virtual_tags_collection,
             h_v2.virtual_tags.VirtualTagAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.virtual_tags_copy,
             h_v2.virtual_tags.VirtualTagCopyAsyncHandler, handler_kwargs),
            (urls_v2.virtual_tag_resource_options,
             h_v2.virtual_tags.VirtualTagResourceOptionsAsyncHandler,
             handler_kwargs),
            (urls_v2.virtual_tags,
             h_v2.virtual_tags.VirtualTagAsyncItemHandler, handler_kwargs),
            (urls_v2.virtual_tag_value_limits,
             h_v2.virtual_tags.VirtualTagValueLimitsAsyncHandler,
             handler_kwargs),
            (urls_v2.virtual_tag_rules_collection,
             h_v2.virtual_tags.VirtualTagRuleAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.virtual_tag_rules,
             h_v2.virtual_tags.VirtualTagRuleAsyncItemHandler, handler_kwargs),
            (urls_v2.virtual_tag_rules_apply,
             h_v2.virtual_tags.VirtualTagRulesApplyAsyncHandler,
             handler_kwargs),
            ...
            (urls_v2.available_filters,
             ...
             handler_kwargs),
            (urls_v2.invoice_months,
             h_v2.invoice_months.InvoiceMonthsAsyncHandler,
             handler_kwargs),
            (urls_v2.import_scheduler,
             h_v2.import_scheduler.ImportSchedulerAsyncHandler,
             handler_kwargs),
