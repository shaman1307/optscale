...
export const GET_INVOICE_MONTHS = "GET_INVOICE_MONTHS";
export const SET_INVOICE_MONTHS = "SET_INVOICE_MONTHS";

export const GET_IMPORT_SCHEDULER = "GET_IMPORT_SCHEDULER";
export const SET_IMPORT_SCHEDULER = "SET_IMPORT_SCHEDULER";
export const UPDATE_IMPORT_SCHEDULER = "UPDATE_IMPORT_SCHEDULER";
...
export const GET_VIRTUAL_TAGS = "GET_VIRTUAL_TAGS";
export const SET_VIRTUAL_TAGS = "SET_VIRTUAL_TAGS";
export const GET_VIRTUAL_TAG = "GET_VIRTUAL_TAG";
export const SET_VIRTUAL_TAG = "SET_VIRTUAL_TAG";
export const CREATE_VIRTUAL_TAG = "CREATE_VIRTUAL_TAG";
export const UPDATE_VIRTUAL_TAG = "UPDATE_VIRTUAL_TAG";
export const DELETE_VIRTUAL_TAG = "DELETE_VIRTUAL_TAG";
export const UPDATE_VIRTUAL_TAG_VALUE_LIMITS = "UPDATE_VIRTUAL_TAG_VALUE_LIMITS";
export const GET_VIRTUAL_TAG_RULES = "GET_VIRTUAL_TAG_RULES";
export const SET_VIRTUAL_TAG_RULES = "SET_VIRTUAL_TAG_RULES";
export const CREATE_VIRTUAL_TAG_RULE = "CREATE_VIRTUAL_TAG_RULE";
export const UPDATE_VIRTUAL_TAG_RULE = "UPDATE_VIRTUAL_TAG_RULE";
export const DELETE_VIRTUAL_TAG_RULE = "DELETE_VIRTUAL_TAG_RULE";
export const COPY_VIRTUAL_TAGS = "COPY_VIRTUAL_TAGS";
export const APPLY_VIRTUAL_TAG_RULES = "APPLY_VIRTUAL_TAG_RULES";
export const GET_VIRTUAL_TAG_APPLY_PROGRESS = "GET_VIRTUAL_TAG_APPLY_PROGRESS";
